  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div style={{
          padding: isMobile ? "24px 20px" : "28px 28px 20px",
        ...
        {/* Footer */}
        <div style={{
          padding: isMobile ? "20px" : "20px 28px",
          ...
          <button
            ...
            style={{
              flex: 1,
              padding: "10px 20px",
              backgroundColor: alreadyMarked ? "#94A3B8" : (loading ? "#94A3B8" : "#6B46C1"),
              color: "#FFFFFF",
              border: "none",
              borderRadius: "6px",
              fontSize: "13px",
              ...
              transition: "all 0.15s ease",
              letterSpacing: "-0.01em",
              boxShadow: (loading || alreadyMarked) ? "none" : "0 1px 3px rgba(107, 70, 193, 0.3)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              gap: "6px"
